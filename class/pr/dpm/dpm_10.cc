// file: dpm_10.cc
// version: $Id: dpm_10.cc  7/16/2013
//
...
bool8 DPM::store(String out_filename,File::TYPE type){
...
bool8 DPM::load(VectorLong seeds,String filename_a){
  ...
  //
  set_hyper_parameters(hyper_params_vec_d);
...
// return: bool8 value
//
// Extract a Mixture  model from raw DPM model file
//
bool8 DPM::extract_model(Sof &outfile,Vector<VectorLong> state_index,int32 this_state_index,int32 out_index,bool8 reduce_a){
if (is_slave_d == true){
...
//
bool8 DPM::read_final_model(Sof& sof_a, int32 tag_a, const String& name_a) {
...
// Extract a Mixture model from raw DPM model file
//
bool8 DPM::extract_model(String input_raw_model_a, String output_model_a,File::TYPE type){
...
Sof outfile;
  ...
  if(is_master_d == false){
    ...
    return Error::handle(name(), L"extract_model should not be called by a master object.", Error::ARG, __FILE__, __LINE__);
...
//
bool8 DPM::load_final_model(String model_a,Database &db_a) {
