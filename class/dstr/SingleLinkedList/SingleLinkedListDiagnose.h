// file: $isip/class/dstr/SingleLinkedList/SingleLinkedListDiagnose.h
// version: $Id: SingleLinkedListDiagnose.h 10636 2007-01-26 22:18:09Z tm334 $
//

// make sure definitions are only made once
//
#ifndef ISIP_SINGLE_LINKED_LIST_DIAGNOSE
#define ISIP_SINGLE_LINKED_LIST_DIAGNOSE
...
// SingleLinkedListDiagnose: a class that contains the diagnose method
// of SingleLinkedList class.
//
template<class TObject>
class SingleLinkedListDiagnose : public SingleLinkedList<TObject> {
...
public:
  ...
  static const String& name() {
    return SingleLinkedList<TObject>::name();
  }
...
// below are all the methods for the SingleLinkedListDiagnose template class
//
...
//
template<class TObject>
bool8 SingleLinkedListDiagnose<TObject>::diagnose(Integral::DEBUG level_a) {
  ...
  if (level_a > Integral::NONE) {
    ...
    output.concat(SingleLinkedList<TObject>::CLASS_NAME);
    output.concat(L": ");
    Console::put(output);
  ...
  //
  SingleLinkedList<TObject>::setDebug(SingleLinkedList<TObject>::debug_level_d);
  ...
  //
  SingleLinkedList<Char> def_list;
  ...
  // copy constructor
  //
  SingleLinkedList<Char> copy_list(def_list);     
  ...
  // memory heap
  //
  SingleLinkedList<Char>* def_dyn_list = new SingleLinkedList<Char>();
  def_dyn_list->insertFirst(items[0]);
  def_dyn_list->insert(items[1]);
  def_dyn_list->insertLast(items[2]);
  
  SingleLinkedList<Char>* copy_dyn_list =
    new SingleLinkedList<Char>(*def_dyn_list);
  ...
  //
  SingleLinkedList<Char> def_list_2;
  ...
  SingleLinkedList<Char> copy_list_2(def_list_2);
  ...
  // memory heap
  //
  SingleLinkedList<Char>* def_dyn_list_2 =
    new SingleLinkedList<Char>(DstrBase::USER);
  
  def_dyn_list_2->insertFirst(items[0]);
  def_dyn_list_2->insert(items[1]);
  def_dyn_list_2->insertLast(items[2]);
  
  SingleLinkedList<Char>* copy_dyn_list_2 =
    new SingleLinkedList<Char>(*def_dyn_list_2);
  ...
  if (level_a >= Integral::ALL) {
    ...
    //
    SingleLinkedList<Char>::setGrowSize((int32)731);
    
    // loop for a large number of times creating and deleting a large number
    // of lists at each loop
    //
    for (int32 j = 1; j <= 10; j++) {
      SingleLinkedList<Char>** system_lists =
	new SingleLinkedList<Char>*[j * 100];
      SingleLinkedList<Char>** lists =
	new SingleLinkedList<Char>*[j * 100];
      
      // create the items
      //
      for (int32 i = 0; i < j * 100; i++) {
	system_lists[i] =  new SingleLinkedList<Char>(DstrBase::USER);
	lists[i] =  new SingleLinkedList<Char>();
      }
    ...
    for (int32 j = 1; j <= 10; j++) {
      ...
      //
      SingleLinkedList<TObject>* system_lists =
	new SingleLinkedList<TObject>[j * 100];
      //      SingleLinkedList<TObject>* lists =
      //	new SingleLinkedList<TObject>[j * 100](DstrBase::USER);
  ...
  // test assign methods
  //  
  SingleLinkedList<Char> tmp_list;         
  SingleLinkedList<Char>* tmp_dyn_list = new SingleLinkedList<Char>();

  SingleLinkedList<Char> tmp_list_1(DstrBase::USER); 
  SingleLinkedList<Char>* tmp_dyn_list_1 = new SingleLinkedList<Char>(DstrBase::USER);
  ...
  write_strings[3]->assign(L"SingleLinkedList");
  write_strings[4]->assign(L"String");
  
  // create lists to write
  //
  SingleLinkedList<Char> write_null_list;
  SingleLinkedList<Char> write_char_list(DstrBase::USER);

  write_char_list.insert(write_chars[0]);
  
  SingleLinkedList<String> write_str_list(DstrBase::USER);

  for (int32 i = 0; i < 5; i++) {
    write_str_list.insert(write_strings[i]);
  }
  
  SingleLinkedList< SingleLinkedList<Char> >
    write_char_list_list(DstrBase::USER);
  SingleLinkedList< SingleLinkedList< SingleLinkedList<Char> > >
    write_char_lll(DstrBase::USER);
  
  // create objects for reading in, all read lists are SYSTEM-allocated
  //
  SingleLinkedList<Char> read_null_list_text;
  SingleLinkedList<Char> read_null_list_bin;
  SingleLinkedList<Char> read_char_list_text;
  SingleLinkedList<Char> read_char_list_bin;
  SingleLinkedList<String> read_str_list_text;
  SingleLinkedList<String> read_str_list_bin;
  
  SingleLinkedList< SingleLinkedList<Char> > read_char_list_list_bin;
  SingleLinkedList< SingleLinkedList<Char> > read_char_list_list_text;
  ...
  //
  SingleLinkedList< SingleLinkedList<Char> >* wc_ll_0 =
    new SingleLinkedList< SingleLinkedList<Char> >(DstrBase::USER);
  SingleLinkedList< SingleLinkedList<Char> >* wc_ll_1 =
    new SingleLinkedList< SingleLinkedList<Char> >(DstrBase::USER);
  ...
  for (int32 i = 0; i < s1; i++) {
    ...
    SingleLinkedList<Char>* temp = new SingleLinkedList<Char>(DstrBase::USER);
    SingleLinkedList<Char>* t1 = new SingleLinkedList<Char>(DstrBase::USER);
    SingleLinkedList<Char>* t2 = new SingleLinkedList<Char>(DstrBase::USER);
  ...
  SingleLinkedList<VectorLong> write_signal_data(DstrBase::USER);
  SingleLinkedList<VectorLong> read_signal_data_text;
  SingleLinkedList<VectorLong> read_signal_data_bin;
  ...
  // clean the memory that was created by the SingleLinkedList read and write
  //
  ...
  //
  SingleLinkedList<Char>* char_list = new SingleLinkedList<Char>;
  ...
  // SYSTEM-allocated
  //
  SingleLinkedList<Char>* char_copy_list_1 = new SingleLinkedList<Char>();
  char_copy_list_1->assign(*char_list);
  
  // USER-allocated
  //
  SingleLinkedList<Char>* char_copy_list_2 =
    new SingleLinkedList<Char>(DstrBase::USER);
  ...
  //
  SingleLinkedList<Char> tmp_list_2;
  ...
  //
  SingleLinkedList<Char> tmplist_test_0;
  tmplist_test_0.insertLast(items[0]);
  SingleLinkedList<Char>* tmplist_test_ptr_0 = new SingleLinkedList<Char>();  
  tmplist_test_ptr_0->insertLast(items[0]);
  delete tmplist_test_ptr_0;
    
  // test the insert last method on an empty list in user mode
  //  
  SingleLinkedList<Char> tmplist_test_1(DstrBase::USER);
  tmplist_test_1.insertLast(items[0]);
  SingleLinkedList<Char>* tmplist_test_ptr_1 =
    new SingleLinkedList<Char>(DstrBase::USER);  
  ...
  //
  SingleLinkedList<Char>* list_ptr_0 =
    new SingleLinkedList<Char>(DstrBase::USER);
  SingleLinkedList<Char>* list_ptr_1 =
    new SingleLinkedList<Char>(DstrBase::USER);
  
  // SYSTEM-allocated
  //
  SingleLinkedList<Char>* list_ptr_2 = new SingleLinkedList<Char>;
  ...
  //
  SingleLinkedList<Char> char_list_1;
  SingleLinkedList<Char> char_list_2;
  SingleLinkedList<Char> char_list_3;
  ...
  //
  SingleLinkedList<Long> int32_list;
  ...
  //
  int32_list.sort(Integral::ASCENDING, SingleLinkedList<Long>::INSERTION);
  ...
  //
  int32_list.sort(Integral::DESCENDING, SingleLinkedList<Long>::INSERTION);
  ...
  // the list now is  "1 2 3 3 4 5 6 7"
  //
  int32_list.sort(Integral::ASCENDING, SingleLinkedList<Long>::RAND_QUICK);
  ...
  // the list now is  "7 6 5 4 3 3 2 1"  
  //
  int32_list.sort(Integral::DESCENDING, SingleLinkedList<Long>::RAND_QUICK);
