// file: $isip/class/math/matrix/MatrixShort/msht_02.cc
// version: $Id: msht_02.cc 5831 2000-12-11 20:14:46Z duncan $
//
...
//
bool8 MatrixShort::diagnose(Integral::DEBUG level_a) {
  ...
  //  
  MMatrix<Short, int16>::diagnose(level_a);
  ...
  //
  MatrixShort mat(4, 4, Integral::FULL);
  ...
  //
  MatrixShort mat0(4, 4, Integral::FULL);
  MatrixShort mat1(4, 4, Integral::SYMMETRIC);
  MatrixShort mat2(4, 4, Integral::LOWER_TRIANGULAR);
  MatrixShort mat3(4, 4, Integral::DIAGONAL);

  MatrixShort mat5(mat0);
  MatrixShort mat6(mat1);
  MatrixShort mat7(mat2);
  MatrixShort mat8(mat3);
  
  // test io methods
  //
  MatrixShort val0;
  MatrixShort val1(3, 3, Integral::DIAGONAL);
  MatrixShort val2(2, 2, Integral::SYMMETRIC);
  MatrixShort val3(3, 3, Integral::LOWER_TRIANGULAR);
  MatrixShort test_val;
  ...
  //
  MatrixShort temp_mat(2, 3, L"5, 5, 5, 5, 5, 5");
