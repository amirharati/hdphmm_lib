// file: $isip/class/math/matrix/MatrixByte/mbyt_02.cc
// version: $Id: mbyt_02.cc 5831 2000-12-11 20:14:46Z duncan $
//
...
//
bool8  MatrixByte::diagnose(Integral::DEBUG level_a) {
  ...
  //  
  MMatrix<Byte, byte8>::diagnose(level_a);
  ...
  //
  MatrixByte mat(4, 4, Integral::FULL);
  ...
  //
  MatrixByte mat0(4, 4, Integral::FULL);
  MatrixByte mat1(4, 4, Integral::SYMMETRIC);
  MatrixByte mat2(4, 4, Integral::LOWER_TRIANGULAR);
  MatrixByte mat3(4, 4, Integral::DIAGONAL);

  MatrixByte mat5(mat0);
  MatrixByte mat6(mat1);
  MatrixByte mat7(mat2);
  MatrixByte mat8(mat3);

  // test io methods
  //
  MatrixByte val0;
  MatrixByte val1(3, 3, Integral::DIAGONAL);
  MatrixByte val2(2, 2, Integral::SYMMETRIC);
  MatrixByte val3(3, 3, Integral::LOWER_TRIANGULAR);
  MatrixByte test_val;
  ...
  //
  MatrixByte temp_mat(2, 3, L"5, 5, 5, 5, 5, 5");
