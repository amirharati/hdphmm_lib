// file: $isip/class/math/matrix/MatrixUshort/musht_02.cc
// version: $Id: musht_02.cc 5831 2000-12-11 20:14:46Z duncan $
//
...
//
bool8 MatrixUshort::diagnose(Integral::DEBUG level_a) {
  ...
  //  
  MMatrix<Ushort, uint16>::diagnose(level_a);
  ...
  //
  MatrixUshort mat(4, 4, Integral::FULL);
  ...
  //
  MatrixUshort mat0(4, 4, Integral::FULL);
  MatrixUshort mat1(4, 4, Integral::SYMMETRIC);
  MatrixUshort mat2(4, 4, Integral::LOWER_TRIANGULAR);
  MatrixUshort mat3(4, 4, Integral::DIAGONAL);

  MatrixUshort mat5(mat0);
  MatrixUshort mat6(mat1);
  MatrixUshort mat7(mat2);
  MatrixUshort mat8(mat3);
  
  // test io methods
  //
  MatrixUshort val0;
  MatrixUshort val1(3, 3, Integral::DIAGONAL);
  MatrixUshort val2(2, 2, Integral::SYMMETRIC);
  MatrixUshort val3(3, 3, Integral::LOWER_TRIANGULAR);
  MatrixUshort test_val;
  ...
  //
  MatrixUshort temp_mat(2, 3, L"5, 5, 5, 5, 5, 5");
