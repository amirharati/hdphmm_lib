// file: $isip/class/math/scalar/Short/shrt_02.cc
// version: $Id: shrt_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 Short::diagnose(Integral::DEBUG level_a) {
  ...
  // 
  MScalar<int16, int16>::diagnose(level_a);  
  ...
  // test operator %
  //
  val_0.assign((int16)8);
  val_1.assign((int16)3);
  val_2 = val_0 % val_1;
  if (val_2 != (int16)2.0) {
  ...
  //
  if (((byte8)val_0.bcmpl((int16)6) & (byte8)0xFF) != (byte8)0xF9) {
