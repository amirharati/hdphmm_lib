// file: $isip/class/math/scalar/Ullong/ullg_02.cc
// version: $Id: ullg_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 Ullong::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MScalar<uint64, uint64>::diagnose(level_a);
  ...
  // test operator %
  //
  val_0.assign((uint64)8);
  val_1.assign((uint64)3);
  val_2 = val_0 % val_1;
  if (val_2 != (uint64)2.0) {
  ...
  //
  if (((byte8)val_0.bcmpl((uint64)6) & (byte8)0xFF) != (byte8)0xF9) {
