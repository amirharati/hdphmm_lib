// file: $isip/class/math/scalar/Ulong/ulng_02.cc
// version: $Id: ulng_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 Ulong::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MScalar<uint32, uint32>::diagnose(level_a);
  ...
  // test operator %
  //
  val_0.assign((uint32)8);
  val_1.assign((uint32)3);
  val_2 = val_0 % val_1;
  if (val_2 != (uint32)2.0) {
  ...
  //
  if (((byte8)val_0.bcmpl((uint32)6) & (byte8)0xFF) != (byte8)0xF9) {
