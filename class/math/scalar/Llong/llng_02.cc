// file: $isip/class/scalar/Llong/llng_02.cc
// version: $Id: llng_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 Llong::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MScalar<int64, int64>::diagnose(level_a);
  ...
  // test operator %
  //
  val_0.assign((int64)8);
  val_1.assign((int64)3);
  val_2 = val_0 % val_1;
  if (val_2 != (int64)2.0) {
  ...
  //
  if (((byte8)val_0.bcmpl((int64)6) & (byte8)0xFF) != (byte8)0xF9) {
