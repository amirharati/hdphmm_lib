// file: $isip/class/math/scalar/Char/char_03.cc
// version: $Id: char_03.cc 4906 2000-09-20 18:25:29Z duncan $
//
...
//
bool8 Char::read(Sof& sof_a, int32 tag_a, const String& name_a) {
...
//  int32 size: (input) the size of filespace for this object to work in
...
//
bool8 Char::readData(Sof& sof_a, const String& pname_a, int32 size_a,
  ...
  //
    ...
    if (sof_a.read(&value_d, sizeof(value_d), 1) != 1) {
      return false;
    }
  }
