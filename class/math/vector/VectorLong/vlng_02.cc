// file: $isip/class/vector/VectorLong/vlng_02.cc
// version: $Id: vlng_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorLong::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<Long, int32>::diagnose(level_a);
  ...
  //
  VectorLong val0((int32)5);
  val0.assign(L"1, 3, 5, 7, 9");
  
  VectorLong val1(val0);
  if (val0.ne(val1)) {
  ...
  // test new and delete
  //
  VectorLong* dyn_val0 = new VectorLong((int32)5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorLong* dyn_val1 = new VectorLong(*dyn_val0);
...
//       //
//       VectorLong* vectors = new VectorLong[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // unichar constructor
  //
  VectorLong temp_vect_2(L"5, 5, 5, 5, 5");
  ...
  val0 = (int32)5;
  if (val0.ne((int32)5)) { 
    return Error::handle(name(), L"=", Error::TEST,
			 __FILE__, __LINE__);
  }
