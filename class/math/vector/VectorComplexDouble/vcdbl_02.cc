// file: $isip/class/vector/VectorComplexDouble/vcdbl_02.cc
// version: $Id: vcdbl_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorComplexDouble::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<ComplexDouble, complexdouble>::diagnose(level_a);
  ...
  //
  VectorComplexDouble val_0;
  VectorComplexDouble val_1(1, (complexdouble)42);

  // create vectors to write
  //
  int32 test_size = 1024;
  VectorComplexDouble val2;
  VectorComplexDouble val3;
  VectorComplexDouble val4(test_size);  
  for (int32 i = 0; i < test_size; i++) {
    val4(i) = (float64)i * 3.1;
  }
  ...
  // test new and delete
  //
  VectorComplexDouble* dyn_val0 = new VectorComplexDouble(5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorComplexDouble* dyn_val1 = new VectorComplexDouble(*dyn_val0);
...
//       //
//       VectorComplexDouble* vectors = new VectorComplexDouble[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // string constructor
  //
  val0 = (complexdouble)5;
  String str(L"5, 5, 5, 5, 5");
  VectorComplexDouble temp_vect_1(str);
  ...
  // unichar constructor
  //
  VectorComplexDouble temp_vect_2(L"5, 5, 5, 5, 5");
  ...
  val0 = (complexdouble)5.3;
  if (val0.ne((complexdouble)5.3)) { 
    return Error::handle(name(), L"=", Error::TEST, __FILE__, __LINE__);
  }
  ...
  VectorDouble a;
  VectorComplexDouble b(L"4+3j, 2, 0 + 4j");

  VectorComplexDouble c;
  c.conjugate(b);

  VectorComplexDouble d(L"4 -3j, 2, 0 - 4j");
