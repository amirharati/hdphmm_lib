// file: $isip/class/vector/VectorUlong/vulg_02.cc
// version: $Id: vulg_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorUlong::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<Ulong, uint32>::diagnose(level_a);
  ...
  //
  VectorUlong val0((uint32)5);
  val0.assign(L"1, 3, 5, 7, 9");
  
  VectorUlong val1(val0);
  if (val0.ne(val1)) {
  ...
  // test new and delete
  //
  VectorUlong* dyn_val0 = new VectorUlong((int32)5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorUlong* dyn_val1 = new VectorUlong(*dyn_val0);
...
//       //
//       VectorUlong* vectors = new VectorUlong[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // unichar constructor
  //
  VectorUlong temp_vect_2(L"5, 5, 5, 5, 5");
