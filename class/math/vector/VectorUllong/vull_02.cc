// file: $isip/class/vector/VectorUllong/vull_02.cc
// version: $Id: vull_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorUllong::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<Ullong, uint64>::diagnose(level_a);
  ...
  //
  VectorUllong val0((uint64)5);
  val0.assign(L"1, 3, 5, 7, 9");
  
  VectorUllong val1(val0);
  if (val0.ne(val1)) {
  ...
  // test new and delete
  //
  VectorUllong* dyn_val0 = new VectorUllong((int32)5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorUllong* dyn_val1 = new VectorUllong(*dyn_val0);
...
//       //
//       VectorUllong* vectors = new VectorUllong[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // unichar constructor
  //
  VectorUllong temp_vect_2(L"5, 5, 5, 5, 5");
