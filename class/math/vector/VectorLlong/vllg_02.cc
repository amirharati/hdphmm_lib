// file: $isip/class/vector/VectorLlong/vllg_02.cc
// version: $Id: vllg_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorLlong::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<Llong, int64>::diagnose(level_a);
  ...
  //
  VectorLlong val0((int64)5);
  val0.assign(L"1, 3, 5, 7, 9");
  
  VectorLlong val1(val0);
  if (val0.ne(val1)) {
  ...
  // test new and delete
  //
  VectorLlong* dyn_val0 = new VectorLlong((long)5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorLlong* dyn_val1 = new VectorLlong(*dyn_val0);
...
//       //
//       VectorLlong* vectors = new VectorLlong[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // unichar constructor
  //
  VectorLlong temp_vect_2(L"5, 5, 5, 5, 5");
