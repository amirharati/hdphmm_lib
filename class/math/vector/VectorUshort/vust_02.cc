// file: $isip/class/vector/VectorUshort/vust_02.cc
// version: $Id: vust_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorUshort::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<Ushort, uint16>::diagnose(level_a);
  ...
  //
  VectorUshort val0((uint16)5);
  val0.assign(L"1, 3, 5, 7, 9");
  
  VectorUshort val1(val0);
  if (val0.ne(val1)) {
  ...
  // test new and delete
  //
  VectorUshort* dyn_val0 = new VectorUshort((int32)5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorUshort* dyn_val1 = new VectorUshort(*dyn_val0);
...
//       //
//       VectorUshort* vectors = new VectorUshort[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // unichar constructor
  //
  VectorUshort temp_vect_2(L"5, 5, 5, 5, 5");
