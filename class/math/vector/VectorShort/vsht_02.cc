// file: $isip/class/vector/VectorShort/vsht_02.cc
// version: $Id: vsht_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorShort::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<Short, int16>::diagnose(level_a);
  ...
  //
  VectorShort val0((int16)5);
  val0.assign(L"1, 3, 5, 7, 9");
  
  VectorShort val1(val0);
  if (val0.ne(val1)) {
  ...
  // test new and delete
  //
  VectorShort* dyn_val0 = new VectorShort((int32)5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorShort* dyn_val1 = new VectorShort(*dyn_val0);
...
//       //
//       VectorShort* vectors = new VectorShort[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // unichar constructor
  //
  VectorShort temp_vect_2(L"5, 5, 5, 5, 5");
