// file: $isip/class/vector/VectorDouble/vdbl_02.cc
// version: $Id: vdbl_02.cc 10636 2007-01-26 22:18:09Z tm334 $
//
...
//
bool8 VectorDouble::diagnose(Integral::DEBUG level_a) {
  ...
  //
  MVector<Double, float64>::diagnose(level_a);
  ...
  //
  VectorDouble val0(5);
  val0.assign(L"1.3, 3.4, 5.2, 7, 9.8");
  
  VectorDouble val1(val0);
  if (val0.ne(val1)) {
  ...
  // test new and delete
  //
  VectorDouble* dyn_val0 = new VectorDouble((int32)5);             
  dyn_val0->assign(L"1, 3, 5, 7, 9");
  
  VectorDouble* dyn_val1 = new VectorDouble(*dyn_val0);
...
//       //
//       VectorDouble* vectors = new VectorDouble[j * 100](num_elem);
...
//       delete [] vectors;
  ...
  // unichar constructor
  //
  VectorDouble temp_vect_2(L"5, 5, 5, 5, 5");
